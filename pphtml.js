/* kate-script
 * author: Jörgen Modin <jorgen@webworks.se>
 * license: BSD
 * revision: 1
 * kate-version: 3.4
 * type: commands
 ...
 *
 * Contains one function that pretty prints HTML
 * All the heavy lifting is done with Einar Lielmanis's js_beautify from:
 * https://github.com/einars/js-beautify
 */
function help(cmd)
{
    if (cmd == "ppphtml") {
        return i18n("Pretty prints HTML and javascript. Based on js_beautify.");
    }
}
...
function action(cmd)
{
    var a = new Object();
    if (cmd == "ppphtml") {
        a.text = i18n("Pretty print HTML and javascript source code");
        a.icon = "";
        a.category = "";
        a.interactive = false;
        a.shortcut = "";
...
---------------
  ...
  The word "js_beautify" changed to "pphtml" by Jörgen Modin, <jorgen@webworks.se>
  ...
  Usage:
    ppphtml(js_source_text);
    ppphtml(js_source_text, options);
...
function ppphtml(js_source_text, options) {
...
// and you will be able to `var ppphtml = require("beautify").ppphtml`.
if (typeof exports !== "undefined") {
    exports.ppphtml = ppphtml;
}
